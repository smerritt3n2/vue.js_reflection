...
<table class="form-table">
    ...
    <tr>
        ...
        <td>
            ...
            <input type="text" name="SLGF_label_Color" id="SLGF_label_Color" value="<?php echo $SLGF_label_Color; ?>" class="my-color-field" data-default-color="#000000" />
            </p>
        </td>
    </tr>
    <tr>
        ...
        <td>
              ...
              <input type="text" name="SLGF_desc_font_Color" id="SLGF_desc_font_Color" value="<?php echo $SLGF_desc_font_Color; ?>" class="my-color-field" data-default-color="#000000" />
        </td>
    </tr>
    <tr>
        ...
        <td>
             ...
             <input type="text" name="SLGF_btn_Color" id="SLGF_btn_Color"  value="<?php echo $SLGF_btn_Color; ?>" class="my-color-field" data-default-color="#31a3dd" />
        </td>
    </tr>
    <tr>
        ...
        <td>
             ...
             <input type="text" name="SLGF_btn_font_Color" id="SLGF_btn_font_Color"  value="<?php echo $SLGF_btn_font_Color; ?>" class="my-color-field" data-default-color="#31a3dd" />
        </td>
    </tr>
        ...
        <td>
            <select name="SLGF_Light_Box" id="SLGF_Light_Box">
                <optgroup label="Select Light Box Styles">
                    ...
                    } ?>><?php esc_html_e( 'Swipe Box', WEBLIZAR_SLGF_TEXT_DOMAIN ); ?>
                    </option>
                </optgroup>
            </select>
            <p class="description">
    ...
    <tr>
        ...
        <td>
            ...
            <input type="text" class="my-color-field" name="wl-hover-color" id="wl-text-color"
                   value="<?php echo $SLGF_Hover_Color; ?>" >
    ...
    <tr>
        ...
        <td>
			<?php if ( $SLGF_Text_BG_Color == "" ) {
             ...
             <input type="text" class="my-color-field" name="wl-text-bg-color" id="wl-text-color"
                   value="<?php echo $SLGF_Text_BG_Color; ?>" >
