...
class SLGF {
	...
	public function slgf_settings_meta_save( $PostID ) {
		...
		die();}
    		...
    		$SLGF_label_Color         = sanitize_option('SLGF_label_Color', $_POST['SLGF_label_Color']);
    		$SLGF_desc_font_Color     = sanitize_option('SLGF_desc_font_Color', $_POST['SLGF_desc_font_Color']);
   			$SLGF_btn_Color           = sanitize_option('SLGF_btn_Color', $_POST['SLGF_btn_Color']);
    		$SLGF_btn_font_Color      = sanitize_option('SLGF_btn_font_Color', $_POST['SLGF_btn_font_Color']);
